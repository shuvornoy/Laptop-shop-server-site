...
async function run() {
  try {
    const bookingsCollection = client.db("useLaptops").collection("bookings");
    const usersCollection = client.db("useLaptops").collection("users");
    const productsCollection = client.db("useLaptops").collection("products");
    const paymentsCollection = client.db("useLaptops").collection("payments");
...
app.get("/", async (req, res) => {
  res.send("laptop shop is server running site");
});
